...
class HLMStandardGenerator:
    ...
    def __init__(self, 
        ...
        self.schedule = {
            "Mon": [
                f"Heavy Squat 1x1-5, 4x5 Backoff - {self.calculated_weights['heavy_squat']} kg",
            ...
            "Fri": [
                ...
                f"Heavy Press 4x5 - {self.calculated_weights['heavy_press']} kg",
